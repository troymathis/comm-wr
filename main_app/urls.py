...
urlpatterns = [
  ...
  path('person/<int:person_id>/assoc_interest/<int:interest_id>/', views.assoc_interest, name='assoc_interest'),
  path('person/<int:person_id>/assoc_interest/<int:interest_id>/delete/', views.assoc_interest_delete, name='assoc_interest_delete'),
